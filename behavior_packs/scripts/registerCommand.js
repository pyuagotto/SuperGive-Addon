import { system, CustomCommandParamType, CommandPermissionLevel, CustomCommandStatus, EntityComponentTypes, ItemStack, ItemComponentTypes } from "@minecraft/server";
...
system.beforeEvents.startup.subscribe((ev) => {
    ...
    registerCommand("pyuagotto:super_give", "commands.give.description", [
    ...
    registerCommand("pyuagotto:super_replaceitem_player", "commands.replaceitem.description", [
    ...
    registerCommand("pyuagotto:super_replaceitem_block", "commands.replaceitem.description", [
    ...
    registerCommand("pyuagotto:test", "commands.replaceitem.description", [], [], (origin) => {
